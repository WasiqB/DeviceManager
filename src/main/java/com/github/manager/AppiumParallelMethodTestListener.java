...
import com.github.annotations.SkipIf;
import com.github.capability.CapabilityManager;
import com.github.context.SessionContext;
import com.github.context.TestExecutionContext;
import com.github.utils.FileFilterParser;
import com.github.utils.Helpers;
import com.github.utils.TestLogger;
...
public final class AppiumParallelMethodTestListener extends Helpers
    ...
    public void beforeInvocation(IInvokedMethod iInvokedMethod, ITestResult iTestResult) {
        ...
        if (!isCloudExecution()) {
            ...
            SkipIf annotation = iInvokedMethod.getTestMethod()
        ...
        try {
            if (!isCloudExecution() && !isRetry(iTestResult)) {
                ...
                if (atdHost.isPresent() && atdPort.isPresent()) {
                    ...
                    new FileFilterParser().getScreenShotPaths(AppiumDeviceManager.getAppiumDevice()
                        .getDevice()
                        .getUdid(), iTestResult);
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        if (!isCloudExecution()) {
            ...
            RetryCount retryCount = iTestResult.getMethod()
                .getConstructorOrMethod()
                .getMethod()

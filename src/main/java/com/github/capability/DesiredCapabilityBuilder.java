...
import com.github.utils.ArtifactsUploader;
import com.github.utils.AvailablePorts;
import com.github.utils.HostArtifact;
import com.github.utils.JsonParser;
...
public class DesiredCapabilityBuilder extends ArtifactsUploader {
    ...
    public void buildDesiredCapability(String jsonPath) throws Exception {
        int port = AppiumDeviceManager.getAppiumDevice()
            .getPort();
        String platform = AppiumDeviceManager.getAppiumDevice()
            .getDevice()
            .getOs();
        boolean isCloud = AppiumDeviceManager.getAppiumDevice()
            .getDevice()
            .isCloud();
    ...
    private void capabilityObject(DesiredCapabilities desiredCapabilities,
        ...
        if (appCapability.equals(key)) {
            ...
            if (AppiumDeviceManager.getAppiumDevice()
                .getDevice()
                .isCloud() || ResourceUtils.isUrl(hostAppPath)) {
    ...
    private void desiredCapabilityForLocalAndRemoteATD(String platform, String jsonPath, int port,
        ...
        if (AppiumDeviceManager.getMobilePlatform()
            ...
            desiredCapabilities.setCapability(AndroidMobileCapabilityType.SYSTEM_PORT, port);
    ...
    private String hostAppPath(Object values, List<HostArtifact> hostArtifacts) {
        ...
        hostArtifact = hostArtifacts.stream()
            .filter(s -> s.getHost()
